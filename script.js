...
const PROJECTS = [
    {
        ...
        metric: "DRAFT SELECTED (TOP 45 GLOBALLY).... AWAITING RESULTS",
        description: "My most detailed project to date, i reccomend looking at the Rookies submission first!. Makeoober is a creative makeover XR game where you step into the role of an intergalactic make-up artist for alien goobers from distant planets. <br> The game was created for a health and beauty retail store, with its visual design carefully tailored to reflect the store's branding and aesthetic. The project also provided our team with a valuable opportunity to gain hands-on experience in XR development, an area in which we had limited prior experience. <br> Made by 4 people (Though finished it in a group of 3)",
        media: [
    ...
    },
    {
        ...
        description: "You play as a spider who must farm bugs, explore the world, and uncover the truth about the government that banished you and your kind. Built with a two-person team. <br> This was our first main project of a game for our university.",
        media: [
    ...
    {
        id: "08",
        title: "Roster Automation (Google Sheets)",
